...
public class Data_Vanilla {
    ...
    public Data_Vanilla(String name) {
        this.name = name;
    }
    ...
    public String toString() {
        return "Data_Vanilla(" + this.getName() + ", " + this.getAge() + ", " + this.getScore() + ", " + Arrays.deepToString(this.getTags()) + ")";
    }

    protected boolean canEqual(Object other) {
        return other instanceof Data_Vanilla;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Data_Vanilla)) {
            return false;
        }
        Data_Vanilla other = (Data_Vanilla) o;
